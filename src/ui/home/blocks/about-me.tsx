        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:gap-10">
            <div className="min-w-0 flex-2">
              ...
              <h3 className="text-2xl font-semibold text-[#DAB025]">Based in Lahore, Pakistan</h3>
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="mt-0.5 font-semibold text-[#003B73]">{fact.value}</p>
                    </div>
                  </div>
                );
              })}
          ...
          <div className="mt-2">
            <p className="mb-4 text-center text-xs font-semibold tracking-[0.14em] text-gray-400 uppercase lg:text-left">
              Core Technologies
            </p>
