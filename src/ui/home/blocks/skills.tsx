      ...
      <div className="flex flex-col gap-2 mx-auto max-w-7xl p-6">
        <div className="flex flex-col gap-4">
          ...
          <p className="text-lg leading-8 text-gray-600">
            <span className="font-semibold text-[#003B73]">Tools</span> and
            technologies I use to build reliable, full‑stack applications — from
            crafting intuitive user interfaces and responsive layouts to
            designing scalable backend systems,{" "}
            <span className="font-semibold text-[#003B73]">APIs</span>, and
            databases. <span className="font-semibold text-[#003B73]">My</span>{" "}
            stack emphasizes clean architecture, performance, and
            maintainability, ensuring every project is production‑ready and
            future‑proof.
          </p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {SKILL_GROUPS.map((group) => (
            ...
            >
              <h3 className="mb-5 text-lg font-bold text-[#0A4A8A]">
                {group.title}
              </h3>
                ...
                {group.items.map((item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      />
                      <span className="text-xs font-medium text-[#09113F]">
                        {item.name}
                      </span>
                    </div>
                  );
